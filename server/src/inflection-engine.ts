...
router.get('/status', (_req: Request, res: Response) => {
  res.json({
    ...
    phases: {
      ...
      phase3_fundamentals: 'pending',
      phase4_valuation: 'pending',
      phase5_pillars: 'pending',
      phase6_classification: 'pending',
      phase7_exhaustion: 'pending',
      phase8_industry: 'pending',
      phase9_alerts: 'pending',
    },
    indicators: [
