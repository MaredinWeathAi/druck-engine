...
exports.getFullFundamentals = getFullFundamentals;
...
// ============================================================================
async function getFullFundamentals(ticker) {
...
router.get('/:ticker/valuation', async (req, res) => {
    const ticker = req.params.ticker.toUpperCase();
    try {
        const full = await getFullFundamentals(ticker);
...
// HELPERS
// ============================================================================
function safeNum(val, divisor = 1) {
...
function getEarningsTrend(surprises) {
...
//# sourceMappingURL=fundamental-data.js.map